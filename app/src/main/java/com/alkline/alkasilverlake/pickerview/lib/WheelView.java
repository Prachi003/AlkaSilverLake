package com.alkline.alkasilverlake.pickerview.lib;
...
import com.alkline.alkasilverlake.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    // 修改这个值可以改变滑行速度
    private static final int VELOCITYFLING = 2;
    int widthMeasureSpec;

    private int mGravity = Gravity.CENTER;
    private int drawCenterContentStart = 0;//中间选中文字开始绘制位置
    private int drawOutContentStart = 0;//非中间文字开始绘制位置
    private static final float SCALECONTENT = 0.4F;//非中间文字则用此控制高度，压扁形成3d错觉
    ...
    private void initPaints() {
     ...
     //   paintOuterText.setTypeface(Typeface.MONOSPACE);
       ...
       // paintCenterText.setTypeface(Typeface.MONOSPACE);
        paintCenterText.setTextSize(textSize + 5);
