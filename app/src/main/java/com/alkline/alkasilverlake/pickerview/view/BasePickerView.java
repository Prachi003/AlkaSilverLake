...
import com.alkline.alkasilverlake.pickerview.listener.OnDismissListener;
import com.alkline.alkasilverlake.pickerview.utils.PickerViewAnimateUtil;
...
public abstract class BasePickerView {
    ...
    protected void setBackGroundparent(ConstraintLayout contentContainer) {
        this.constraintLayout = contentContainer;
    }
