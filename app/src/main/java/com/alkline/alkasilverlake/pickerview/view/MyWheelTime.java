...
import com.alkline.alkasilverlake.pickerview.TimePickerView;
import com.alkline.alkasilverlake.pickerview.adapter.ArrayWheelAdapter;
import com.alkline.alkasilverlake.pickerview.adapter.NumericWheelAdapter;
...
public class MyWheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m, int s, int ampm) {
        ...
        wv_seconds = view.findViewById(R.id.sec);
        ...
        wv_ampm = view.findViewById(R.id.amPm);
