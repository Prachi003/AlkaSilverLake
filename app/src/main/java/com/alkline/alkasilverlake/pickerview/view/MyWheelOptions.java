...
import com.alkline.alkasilverlake.pickerview.adapter.ArrayWheelAdapter;
import com.alkline.alkasilverlake.pickerview.lib.WheelView;
import com.alkline.alkasilverlake.pickerview.listener.OnItemSelectedListener;
...
public class MyWheelOptions<T> {
    ...
    private ArrayList<WaterNameData> mOptions1Items;
    private ArrayList<RecycleBottleData> mOptions2Items;
    private ArrayList<BottleData> mOptions3Items;
    ...
    public void setPicker(ArrayList<WaterNameData> options1Items,
                          ArrayList<RecycleBottleData> options2Items,
                          ArrayList<BottleData> options3Items,
                          boolean linkage) {
...
//		// 添加联动监听
    ...
    public void setPickerRec(ArrayList<WaterNameData> options1Items,
                          ArrayList<RecycleBottleData> options2Items,
                          ArrayList<BottleData> options3Items,
                          boolean linkage) {
        this.linkage = linkage;
...
//		// 添加联动监听
    ...
    public void setPickerRecycler(ArrayList<RecycleBottleData> options1Items, boolean linkage) {
        this.linkage = linkage;
        ArrayList<RecycleBottleData> mRecycleBottleData = options1Items;
        int len = ArrayWheelAdapter.DEFAULT_LENGTH;
        /*if (this.mOptions3Items == null)
            len = 4;
        if (this.mOptions2Items == null)
      ...
      /*  wheelListener_option1 = new OnItemSelectedListener() {
        ...
        wheelListener_option2 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (mOptions3Items != null) {
                    int opt1Select = wv_option2.getCurrentItem();
                   /* opt1Select = opt1Select >= mOptions3Items.size() - 1 ? mOptions3Items.size() - 1 : opt1Select;
                    index = index >= mOptions2Items.get(opt1Select).size() - 1 ? mOptions2Items.get(opt1Select).size() - 1 : index;
                    int opt3 = wv_option3.getCurrentItem();
